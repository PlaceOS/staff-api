...
describe Staff do
  describe "#index" do
    it "should return a list of users" do
      ctx = context("GET", "/api/staff/v1/people", OFFICE365_HEADERS)
  ...
  it "#show should return a single user" do
    ...
    ctx = context("GET", "/api/staff/v1/people/#{user_id}", OFFICE365_HEADERS)
    ctx.route_params = {"id" => user_id}
    ctx.response.output = IO::Memory.new
    ...
    user = PlaceCalendar::User.from_json(ctx.response.output.to_s)
